    ...
    for level_data in json_data["levels"]:
        ...
        for field_data in level_data["optional_fields"]:
            if field_data["field_type"] == "mapTitle":
                ...
                field = create_monster_movement_field(field_data["monsters"])
...
json_file = "data/yuyangm_cc1.json"
json_data = load_json_data(json_file)
cc_level_pack = json_to_cc_level_pack(json_data)
dat_file = "data/yuyangm_cc1.dat"
